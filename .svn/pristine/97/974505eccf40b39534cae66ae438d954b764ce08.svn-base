...
<div id="content">
    <div class="you">
        ...
        <div class="video">
            <div class="back"><a style="color: #fff;" href="<?php echo Yii::app()->request->baseurl; ?>/videos/recent"><img src="/webassets/images/play/Button_Back.png"/> Volver</a></div>
            ...
            <div class="pInfo">
                <div class="bold" style="color:white;font-size:16px;display: inline-block;"><?php echo $video->title; ?></div>
                <div style="color:#FFF;font-size:11px;float:right;position: relative;top:3px;">
                    <span style="margin-right:20px;"><?php echo date("F j, Y",strtotime($video->created_on)); ?></span>
                    <span>Vistas: <?php echo $video->views; ?></span>
                </div>
            </div>
        </div>
    </div>
