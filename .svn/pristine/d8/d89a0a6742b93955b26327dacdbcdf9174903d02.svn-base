                ...
                <div class="twitter" style="float:left;">
                    <span id="twitter_user">
                        <?php if (!empty($user->userTwitters[0]->id)): ?>
                            ...
                            <a style="color:#2b7abf;font-weight: bold;" href="http://www.twitter.com/<?php echo (isset($twuser->screen_name) ? $twuser->screen_name : ''); ?>" target="_blank"><?php echo isset($twuser->screen_name) ? $twuser->screen_name : ''; ?></a>
                        <?php else: ?>
