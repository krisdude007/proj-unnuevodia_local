...
<div class="fab-page-content">
    ...
    <div id="fab-top">
        <h2 style="color: rgb(4, 4, 4);" class="fab-title"><img class="floatLeft marginRight10" style="margin-top:5px;" src="<?php echo Yii::app()->request->baseUrl; ?>/core/webassets/images/settings-image.png">Training</h2>
    </div>
        ...
        <div class="fab-row-fluid">
            ...
            <div id="player" class="player">
                <object
                    ...
                    <embed src="/core/webassets/swf/player.swf"
                           width="700"
                           height="400"
                           wmode="transparent"
            ...
            <div class="admin_video_list">
                <div class="admin_video_category">
                    <?php if(Yii::app()->params['training']['showManual']): ?>
                    ...
                    <button type="button" id="fab-upload-manual-button" class="fab-right-filter" style="margin-top:3px;padding-top:0"><i>Upload Manual</i></button>

                    <?php endif; ?>
                    <?php if(Yii::app()->params['training']['showSchedule']): ?>
                    <div class="admin_video_category_name">
                        <h2>Admin Youtoo TV Schedule</h2>
                    </div>

                    <div class="admin_video_item">
                        <span class="admin_video_display_name">
                        <a target="_blank" href="<?php echo Yii::app()->request->baseUrl; ?>/you/schedule">
                            ADMIN Youtoo America TV Schedule
                        </a>
                            </span>

                    </div>
                    <button type="button" id="fab-upload-schedule-button" class="fab-right-filter" style="margin-top:3px;padding-top:0"><i>Upload Schedule</i></button>
                    ...
                    <!-- Language Filter videos -->
                    <div class="admin_video_category_name">
                        <h2>Contact & Language Filter Service Videos</h2>
                    </div>

                    <div class="admin_video_item">
                        <a class="trainingVideoTrigger" href="<?php echo Yii::app()->request->baseUrl; ?>/core/webassets/swf/training/Service_Contact_LanguageFilter.mov">
                            <span class="admin_video_display_name">Contact/Language: Overview</span>
                            <img class="admin_video_thumb" src="<?php echo Yii::app()->request->baseUrl; ?>/core/webassets/images/training/Service_Contact_LanguageFilter.jpg" />
                        </a>
                    </div>
...
<!-- END PAGE -->
            ...
            ?>
            <?php
            $this->renderPartial('/admin/_overlayScheduleUpload', array(
                    'formUploadManualModel'=>$formUploadManualModel,
                )
            );
            ?>
