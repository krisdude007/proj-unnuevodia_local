...
class eTvScreenAppearSetting extends TvScreenAppearSetting {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('template, poll_title, font_color,font_color_2,bar_color_1,bar_color_2,bar_color_3,bar_color_4', 'safe'),
            array('font_size_2,slide_speed, offset_x, offset_y', 'safe'),
            ...
            array('id, screen_type, template, poll_title, filename, gradient_start_color,gradient_end_color,forebg_filename, entity_type, font_family, font_size, font_color,font_size_2,font_color_2,bar_color_1,bar_color_2,bar_color_3,bar_color_4,slide_speed, direction, offset_x, offset_y, created_on, updated_on', 'safe', 'on' => 'search'),
        );
    }
