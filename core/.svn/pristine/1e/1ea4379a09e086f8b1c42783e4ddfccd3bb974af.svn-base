...
class Video extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('user_id, question_id, hero_user_id, processed, watermarked, to_youtube, to_facebook, to_twitter, arbitrator_id, is_default_ad, roll_type', 'numerical', 'integerOnly'=>true),
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'heroUser' => array(self::BELONGS_TO, 'User', 'hero_user_id'),
    ...
    public function search()
    {
        ...
        $criteria->compare('hero_user_id',$this->hero_user_id);
