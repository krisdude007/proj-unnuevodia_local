 ...
 * @property User $user
 */
class GamingTransaction extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, game_choice_id, processor, request, response, description, price, created_on', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'creditTransactions' => array(self::HAS_MANY, 'CreditTransaction', 'trans_id'),
