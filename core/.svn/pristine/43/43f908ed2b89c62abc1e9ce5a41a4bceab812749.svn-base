                                ...
                                <div style="overflow: hidden;">
                                    ...
                                    <?php $count++; ?>
                                        <div style="float:left;margin: 10px;">
                                            <?php $avatarPath = empty($entityAnswer->eUser->avatarImages[0]->filename)?'/webassets/images/you/profile-avitar.png':'/userimages/'.$entityAnswer->eUser->avatarImages[0]->filename; ?>
