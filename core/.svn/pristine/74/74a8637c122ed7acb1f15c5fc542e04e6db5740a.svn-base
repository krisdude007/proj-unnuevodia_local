...
<div class="form">
    ...
    ?>
    <div <?php echo (Yii::app()->params['enableUserFunctionality'] == true) ? 'class="floatLeft" style="width:34%;"' : 'class="floatLeft" style="width:48%;"'; ?>>
     ...
     if (Yii::app()->params['enableUserFunctionality'] == true) {
         ...
         $arr['imageId'] = $imageId;
          ...
          if (Yii::app()->params['enableUserFunctionality'] == true) {
          $arr2['imageId'] = $imageId;
          }

          if (Yii::app()->params['enableUserFunctionality'] == true) {
          $this->renderPartial('_formPhotoId', $arr2);
          }
          ?>
         <div <?php echo (Yii::app()->params['enableUserFunctionality'] == true) ?  'style="width:22%; float: right;"' : 'style="width:48%; float:left"';?>>
          <?php if (Yii::app()->params['enableUserPermissions'] == true): ?>
        <?php
            $selections = array();
