 ...
 */
class GeoLocationInfo extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, user_id, latitude, longitude, ip_address, is_validlocation, is_preshare, is_share, city, state, created_on, updated_on', 'safe', 'on'=>'search'),
		);
	}
