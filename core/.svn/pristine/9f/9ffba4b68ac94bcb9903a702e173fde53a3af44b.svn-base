...
class Question extends ActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, question, hashtag, start_time, end_time, created_on, updated_on', 'required'),
			...
			array('id, user_id, is_ticker, is_deleted, question, hashtag, start_time, end_time, created_on, updated_on', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'videos' => array(self::HAS_MANY, 'Video', 'question_id'),
		);
	}
