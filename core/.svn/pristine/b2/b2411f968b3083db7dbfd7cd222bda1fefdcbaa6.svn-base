...
class Video extends ActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('user_id, question_id, hero_user_id, processed, watermarked, is_preroll, to_youtube, to_facebook, to_twitter, arbitrator_id, is_default_ad, roll_type', 'numerical', 'integerOnly'=>true),
