        ...
        <?php endif; ?>
                                        ...
                                        <a rel="#videoOverlay" href="<?php echo Yii::app()->request->baseUrl; ?>/adminVideo/videoModal/id/<?php echo $video->id; ?>/currentStatus/" class="videoModalTrigger">
                                            <div class="videoThumb" align="center">
                                                ...
                                                ?>
                                                <img class="videoThumbnail videoThumb <?php echo $styleClass ?>" alt="video-image" src="<?php echo Yii::app()->request->baseUrl; ?>/<?php echo basename(Yii::app()->params['paths']['video']); ?>/<?php echo $video->thumbnail; ?><?php echo Yii::app()->params['video']['imageExt']; ?>" style="float: none;">
