    ...
    var handleResponsive = function () {
        ...
        var handleElements = function () {
            ...
            if ($(window).width() < 900) { // remove sidebar toggler
                $.cookie('fab-sidebar-closed', null);
                $('.fab-page-container').removeClass("sidebar-closed");
            }
        ...
        $(window).bind('exitBreakpoint320', function () {
            handleElements();
            $(".fab-page-container").css('background','none');
            $(".fab-select-question").css('width','352px');
        });
        $(window).bind('enterBreakpoint320', function () {
            if (App.isPage("video")) {
                $("#fab-video-filter-form ").css('border','0px');
                $(".fab-red-line").css('border','0px');
                $(".fab-b-left ").css('border','0px');
            }
            $("#fab-ticker-filter-form").css('border','0px');
            $(".fab-form-right-ticker").css('border-left','0px');
            $(".fab-pull-right").css('margin-top','10px');
            $(".fab-page-container").css('background','black');
            $("fab-.select-question").css('width','100%');
            handleElements();
        });
        ...
        $(window).bind('enterBreakpoint480', function () {
            ...
            $("#fab-ticker-filter-form").css('border','0px');
            $(".form-right-ticker").css('border-left','0px');
            $(".fab-pull-right").css('margin-top','10px');
            $(".fab-page-container").css('background','black');
            handleElements();
        });
        ...
        $(window).bind('exitBreakpoint768', function () {
            handleElements();
            $(".fab-pull-right").css('margin-top','0px');
        });
        ...
        $(window).bind('enterBreakpoint900', function () {
            //$(".fab-page-sidebar").removeClass('in');
            if (App.isPage("video")) {
                $(".fab-red-line").css('border-bottom','1px solid #ABA9A9');
                $(".fab-b-left ").css('border-left','1px solid #ABA9A9');
            }
            $("#fab-ticker-filter-form").css('border','0px');
            $(".fab-form-right-ticker").css('border-left','0px');
            handleElements();
        ...
        $(window).bind('enterBreakpoint1024', function () {
            ...
            $("#fab-ticker-filter-form").css('border','1px solid #ABA9A9');
            $(".fab-form-right-ticker").css('border-left','1px solid #ABA9A9');
            handleElements();
        });
...
//                }
            ...
            if (sub.is(":visible")) {
                ...
                jQuery('.fab-arrow', jQuery(this)).addClass("fab-open");
    ...
    var handleSidebarToggler = function () {
        ...
        var container = $(".fab-page-container");
        ...
        $('.fab-page-sidebar .fab-sidebar-toggler').click(function () {
            $(".fab-sidebar-search").removeClass("fab-open");
        ...
        $('.fab-sidebar-search .fab-remove').click(function () {
            $('.fab-sidebar-search').removeClass("fab-open");
        });

        // handle the search query submit on enter press
        $('.fab-sidebar-search input').keypress(function (e) {
            if (e.which == 13) {
        ...
        $('.fab-sidebar-search .fab-submit').click(function () {
            if ($('.fab-page-container').hasClass("fab-sidebar-closed")) {
                if ($('.fab-sidebar-search').hasClass('fab-open') == false) {
                    $('.fab-sidebar-search').addClass("fab-open");
                } else {
                    window.location.href = "extra_search.html";
                }
            } else {
    ...
    var handlePortletTools = function () {
        jQuery('.fab-portlet .fab-tools a.fab-remove').click(function () {
            var removable = jQuery(this).parents(".fab-portlet");
            if (removable.next().hasClass('fab-portlet') || removable.prev().hasClass('fab-portlet')) {
                jQuery(this).parents(".fab-portlet").remove();
            } else {
                jQuery(this).parents(".fab-portlet").parent().remove();
            }
        });

        jQuery('.fab-portlet .fab-tools a.fab-reload').click(function () {
            var el = jQuery(this).parents(".fab-portlet");
            App.blockUI(el);
        ...
        jQuery('.fab-portlet .fab-tools .fab-collapse, .fab-portlet .fab-tools .fab-expand').click(function () {
            var el = jQuery(this).parents(".fab-portlet").children(".fab-portlet-body");
            if (jQuery(this).hasClass("fab-collapse")) {
                jQuery(this).removeClass("fab-collapse").addClass("fab-expand");
                el.slideUp(200);
            } else {
                jQuery(this).removeClass("fab-expand").addClass("fab-collapse");
                el.slideDown(200);
            }
        });
    ...
    var handleLoginForm = function () {
        $('.fab-login-form input').keypress(function (e) {
            if (e.which == 13) {
        ...
        jQuery('#fab-forget-password').click(function () {
            jQuery('.fab-login-form').hide();
            jQuery('.fab-forget-form').show();
        });

        jQuery('#fab-forget-btn, #fab-back-btn').click(function () {
            jQuery('.fab-login-form').show();
            jQuery('.fab-forget-form').hide();
        });

        jQuery('#fab-register-btn').click(function () {
            jQuery('.fab-login-form').hide();
            jQuery('.fab-register-form').show();
        });

        jQuery('#fab-register-back-btn').click(function () {
            jQuery('.fab-login-form').show();
            jQuery('.fab-register-form').hide();
        });
    }
    ...
    var handleChat = function () {
        ...
        var handleClick = function () {
            ...
            var tpl = '';
            tpl += '<li class="out">';
            tpl += '<img class="avatar" alt="" src="../images/avatar1.jpg"/>';
...
$(window).resize(function(){
    ...
    if (new_width<979){
        $("#fab-nav-collapsed").css('display','none !important');
        $("#fab-small-menu").css('display','block !important');
    } else {
        $("#fab-nav-collapsed").css('display','block !important');
        $("#fab-small-menu").css('display','none !important');
    }
                
})
  //dropdown menu
    $(".fab-dropdown-menu").hide();
    $(".fab-dropdown-toggle").click(function(){
        $(".fab-dropdown-menu").hide(); 
        $(this).next('.fab-dropdown-menu').toggle();
    })
    $(".fab-search-input").click(function(e){
        e.stopPropagation();
        return false;
    })
