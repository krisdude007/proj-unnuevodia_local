    ...
    <div id="bgOptionTemplate">
        <div class="clearfix">
            ...
            echo $form->radioButtonList($formTvScreenSettingModel, 'template', array(
                'vertical' => '<img src="/webassets/images/poll/h.jpg" style="height: 50px"/>', 'horizontal' => '<img src="/webassets/images/s.jpg" style="height: 50px"/>'), array('class' => 'radioLabel', 'separator' => '&nbsp;'));
            ?>
        </div>
    </div>
</div>
