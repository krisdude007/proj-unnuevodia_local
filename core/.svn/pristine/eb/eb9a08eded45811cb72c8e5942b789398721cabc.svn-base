...
class GameChoiceAnswer extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('game_choice_id, user_id, label, answer, point_value, created_on, updated_on', 'required'),
	...
	public function relations()
	{
		...
		return array(
			...
			'gameChoiceResponses' => array(self::HAS_MANY, 'GameChoiceResponse', 'game_choice_answer_id'),
		);
	}
