...
class CountryUtility {
    ...
    public static function getNamesAR() {
        $countries = array(
            '' => 'اختر الدولة',
            'EG' => 'مصر',
            'JO' => 'الأردن',
    ...
    public static function countryIsoToName($country = NULL) {
        ...
        $countryCode['CD'] = 'Congo, Democratic Republic';
        $countryCode['CK'] = 'Cook Islands';
        $countryCode['CR'] = 'Costa Rica';
        $countryCode['CI'] = 'Cote DIvoire';
        ...
        $countryCode['HM'] = 'Heard Island & Mcdonald Islands';
        ...
        $countryCode['LA'] = 'Lao Peoples Democratic Republic';
        ...
        $countryCode['VC'] = 'Saint Vincent And Grenadines';
        ...
        $countryCode['GS'] = 'South Georgia And Sandwich Isl.';
        ...
        $countryCode['UM'] = 'United States Outlying Islands';
    ...
    public static function getCurrency($country = NULL, $operator = NULL) {
    ...
    public static function getPrice($country = NULL, $operator = NULL) {

        $price['egypt']['etisalat'] = 5;
        $price['egypt']['vodafone'] = 5;
        $price['egypt']['mobinil'] = 5;
        $price['uae']['etisalat'] = 5;
        $price['uae']['du'] = 5;
        $price['iraq']['asiacell'] = 600;
        $price['iraq']['zainiq'] = 600;
        $price['bahrain']['batelco'] = 0.5;
        $price['bahrain']['zain'] = 0.5;
        $price['bahrain']['viva'] = 0.5;
        $price['jordan']['umniah'] = 0.5;
        $price['jordan']['zain'] = 0.4;
        $price['oman']['nawras'] = 0.5;
        $price['oman']['omantel'] = 0.5;
        $price['qatar']['qtel'] = 5;
        $price['ksa']['omanmobile'] = 5;
        $price['qatar']['qtel'] = 5;

        if (!is_null($operator) && !is_null($country)) {
            return $price[$country][$operator];
        }
        return false;
    }
