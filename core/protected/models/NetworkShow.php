 ...
 */
class NetworkShow extends ActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('name, abbreviation, description, created_on', 'required'),
            array('name', 'length', 'max'=>255),
            array('abbreviation', 'length', 'max'=>3),
            array('updated_on', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, name, abbreviation, description, created_on, updated_on', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            'networkShowSchedules' => array(self::HAS_MANY, 'NetworkShowSchedule', 'network_show_id'),
        );
    }
