 ...
 * @property User $user
 */
class QuestionDestination extends ActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('question_id, user_id, destination_id, response, created_on, updated_on', 'required'),
	 ...
	 * @return QuestionDestination the static model class
	 */
