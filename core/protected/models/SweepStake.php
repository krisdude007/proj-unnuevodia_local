...
/**
 * This is the model class for table "SweepStake".
 *
 * The followings are the available columns in table 'sweepstake':
 * @property integer $id
...
class SweepStake extends ActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SweepStake the static model class
	 */
        ...
        public function rules()
	{
		...
		return array(
			array('title, content, rules, start_date, end_date, created_on, updated_on', 'required'),
			array('title', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, title, content, start_date, end_date, active, created_on, updated_on', 'safe', 'on'=>'search'),
		);
	}
