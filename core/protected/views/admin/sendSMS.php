                        ...
                        <div class="form">
                            <div style="width:600px" class="fab-left fab-voting-left">
                                ...
                                ?>
                                    ...
                                    <div>
                                        <label for="Language"><?php echo Yii::t('youtoo', 'Language') ?></label> <label class="red">*</label>
                                        <?php $array = array('arabic'=>'Arabic','english'=>'English');
                                        echo CHtml::radioButtonList('language','arabic',$array, array( 'separator' => " ")); ?>
                                    </div>
