            ...
            <div class="fab-detail-videos fab-left">
                <div class="fab-details-myslider">
                    <section class="slider" style="margin-left: 30px;">
                        <h1><?php echo CHtml::decode($image->title); ?></h1>
                        <div id="modalImageContainer">
                            ...
                            <div style="position: absolute; bottom: 0;">
                                <button id="btnRotateImageLeft" href="#" class="btn"><i class="icon-white icon-repeat"></i> -90°</button>
                                <button id="btnRotateImageRight" href="#" class="btn"><i class="icon-white icon-repeat icon-flipped"></i> +90°</button>
                            ...
                            <div class="fab-form-right">
                                <div>
                                    ...
                                    <?php if (Yii::app()->params['showUserCountry']): ?>
                                        <?php if (isset($image->user->userLocations[0]->country)): ?>
                                            <p><b>Country: </b> <?php echo $image->user->userLocations[0]->country; ?></p>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    ...
                                    <div class="fab-left" style="margin-top:3px; margin-bottom: 20px;">
                                        <div><?php
                                        $opt = array('Y' => 'Send Email', 'N' => 'Don`t Send Email');
                                        echo CHtml::dropDownList('optSendEmail', 'Y', $opt, array('style' => 'width: 130px;')) ?></div>
                                        <button id="fab-modal-accept-button"  value="<?php echo $image->status; ?>" class="fab-accept-button" onclick="updateImageStatus('accepted', '<?php echo $currentStatus; ?>', <?php echo $image->id; ?>);
                                                return false;">Accept</button>
                                        <button id="fab-modal-deny-button" value="<?php echo $image->status; ?>" class="fab-deny-button" onclick="updateImageStatus('denied', '<?php echo $currentStatus; ?>', <?php echo $image->id; ?>);
