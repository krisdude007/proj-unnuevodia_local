...
<div class="tFormOverlay" id="header">
    ...
    <div class="formBox">
        <?php
        $this->renderPartial('/adminTvScreenAppearSetting/_pollSettingForm', array('form' => $form, 'formTvScreenSettingModel' => $formTvScreenSettingModel, 'foreBgimageFile' => $foreBgimageFile, 'BgimageFile' => $BgimageFile));
        $this->renderPartial('/adminTvScreenAppearSetting/_pollToolsForm', array('form' => $form, 'formTvScreenSettingModel' => $formTvScreenSettingModel));
        ?>
