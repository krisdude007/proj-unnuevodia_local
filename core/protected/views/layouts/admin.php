...
if(Yii::app()->params['analyticsTracking']['id']) {
    $cs->registerScript('googleanalytics', "(function(i, s, o, g, r, a, m) {
            ...
            ga('create', '".Yii::app()->params['analyticsTracking']['id']."', 'auto');
                ...
                <ul id="adminNav">
                    ...
                    <?php if (in_array('HAS_GAME', Yii::app()->params['features']) && (Yii::app()->user->isSuperAdmin() || Yii::app()->user->isSiteAdmin() || Yii::app()->user->hasPermission('admingame'))): ?>
                        ...
                        if (in_array('HAS_GAME_MULTIPLE_CHOICE', Yii::app()->params['features']) && !in_array('HAS_GAME_HOT_OR_NOT', Yii::app()->params['features']) && !in_array('HAS_GAME_CELEBRITY_REVEAL', Yii::app()->params['features'])) {
                            $gameURL = "/admin/gamechoice/multiple?g=open";
                        } else {
                            $gameURL = "/admin/game";
                        }
                        ?>
                    ...
                    <?php endif; ?>
                    <?php if (in_array('HAS_EMAIL', Yii::app()->params['features']) && (Yii::app()->user->isSuperAdmin() || Yii::app()->user->isSiteAdmin() || Yii::app()->user->hasPermission('adminemail'))): ?>
                        <li <?php echo (Yii::app()->controller->id == 'adminEmail' && Yii::app()->controller->action->id == 'index') ? 'class="on"' : ''; ?>>
                            <a href="/adminEmail">
