                ...
                for (j=0; j<nc; j++) {
                    if (idx < series.length && (series[idx].show || series[idx].showLabel)){
                        ...
                        if (lt) {
                            ...
                            div0.attr('id', 'outDiv' + i);
                            div0.addClass('jqplot-table-legend-swatch-outline');
                            div1 = $(document.createElement('div'));
                            div1.addClass('jqplot-table-legend-swatch');
                            div1.attr('id', 'swDiv' + i);
                            div1.css({backgroundColor: color, borderColor: color});
                            divWrap = $(document.createElement('div'));
                            divWrap.css({width:'40px'});
                            divWrap.attr('id', 'cbDiv' + i);

                            td1.append(divWrap.append(div0.append(div1)));
                            ...
                            if (this.seriesToggle) {
                                ...
                                if (this.showSwatches) {
                                    ...
                                    var temp = divWrap.append(input);
                                    temp.bind('click', {series:s, speed:speed, plot: plot, replot:this.seriesToggleReplot}, handleToggle);
...
//                                }
    ...
    var handleToggle = function (ev) {
        ...
        var groupNum = ev.target.id.substr(ev.target.id.length -1);
        var theCb = $('#cb' + groupNum);
        if(showing){
...
//                    var rows = $('.jqplot-table-legend > tbody > tr > td > input');
//                    if(rows[sidx].checked == false){
//                        rows[sidx].checked = true;
//                    }else{
//                        rows[sidx].checked = false;
//                    }
                }
                else {
                    if (typeof plot.options.legend.showSwatches === 'undefined' || plot.options.legend.showSwatches === true) {
