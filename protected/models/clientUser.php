...
class clientUser extends eUser
{
    ...
    public function rules()
    {
            ...
            return array(
                ...
                array('password, source, confirm_password','required','on'=>'register,twitter'),
                ...
                array('terms_accepted', 'required', 'requiredValue' => 1, 'message' => 'Por favor, acepte los términos.'),
